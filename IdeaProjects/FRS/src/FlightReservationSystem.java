...
public class FlightReservationSystem {
    public static void main(String[] args) {
        Address a = new Address("Prakruthi nagar","Chitradurga","Karnataka");
        System.out.println(a.getAddressDetails());
        a.updateAddressDetails("Ambedkar Nagar@Chitradurga@Karnataka");
        System.out.println(a.getAddressDetails());
        a.updateAddressDetails("Bapuji nagar","Chitradurga","Karnataka");
        System.out.println(a.getAddressDetails());

        Contact c = new Contact("Nuthan","9164052521","nuthancreddy@gmail.com");
        System.out.println(c.getContactDetails());
        c.setContactDetails("shakeel@9704617009@shakeel88taj@gmail.com");
        System.out.println(c.getContactDetails());
        c.setContactDetails("Bhavana","9899878799","sakeenassb@gmail.com");
        System.out.println(c.getContactDetails());
        ...
        Passenger p = new Passenger(1,"red","9877665766","asd@gmail.com","gandhi street", "vizag","AP");
